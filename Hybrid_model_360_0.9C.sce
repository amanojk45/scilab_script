...
N=8000;
r = exp(-k * dt);
exec('C:\Users\pghaj\Desktop\Scilab pgms\unit.sci', -1);
for t=1:N
    i(t)=0.94*(U(t)-U(t-180)+U(t-360)-U(t-540)+U(t-720)-U(t-900)+...
    U(t-1080)-U(t-1260)+U(t-1440)-U(t-1620)+U(t-1800)-U(t-1980)+...
    U(t-2160)-U(t-2340)+U(t-2520)-U(t-2700)+U(t-2880)-U(t-3060)+...
    U(t-3240)-U(t-3420)+U(t-3600)-U(t-3780)+U(t-3960)-U(t-4140)+...
    U(t-4320)-U(t-4500)+U(t-4680)-U(t-4860)+U(t-5040)-U(t-5220)+...
    U(t-5400)-U(t-5580)+U(t-5760)-U(t-5940)+U(t-6120)-U(t-6300)+...
    U(t-6480)-U(t-6660)+U(t-6840)-U(t-7020)+U(t-7200)-U(t-7380)+...
    U(t-7560)-U(t-7740));
end
for t=1:N    
    y(t) = y1(t) + y2(t);
