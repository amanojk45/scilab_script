...
for t=1:N
    i(t)=2.31*(U(t)-U(t-120)+U(t-240)-U(t-360)+U(t-480)-U(t-600)+U(t-720)-..
    U(t-840)+U(t-960)-U(t-1080)+U(t-1200)-U(t-1320)+U(t-1440)-U(t-1560)+..
    U(t-1680)-U(t-1800)+U(t-1920)-U(t-2040)+U(t-2160)-U(t-2280)+U(t-2400)-..
    U(t-2520)+U(t-2640)-U(t-2760)+U(t-2880)-U(t-3000)+U(t-3120)-U(t-3240)+..
    U(t-3360)-U(t-3480));
end
for t=1:N    
    y(t) = y1(t) + y2(t);
