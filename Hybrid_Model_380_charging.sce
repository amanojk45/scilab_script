...
for t=1:N
    i(t)=-0.945*(U(t)-U(t-380)+U(t-760)-U(t-1140)+U(t-1520)-U(t-1900)+U(t-2280)-..
    U(t-2660)+U(t-3040)-U(t-3420)+U(t-3800)-U(t-4180)+U(t-4560)-U(t-4940)+..
    U(t-5320)-U(t-5700)+U(t-6080)-U(t-6460)+U(t-6840)-U(t-7220)+U(t-7600)-U(t-7980));
end
for t=1:N    
    y(t) = y1(t) + y2(t);
